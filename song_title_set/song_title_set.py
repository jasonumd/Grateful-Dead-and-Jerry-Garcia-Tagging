...
# 1: String representing drive letter where your library resides. Example "D".
...
with open(infile, "r") as file:
    ...
    for line in file:
        ...
        #I am setting a segue if the file contains one OR the database contains one.
        if songsegue == ">":
            segue = " >"
        ...
        if len(result) == 0: #No songs
            ...
            #This could create a segue error.
